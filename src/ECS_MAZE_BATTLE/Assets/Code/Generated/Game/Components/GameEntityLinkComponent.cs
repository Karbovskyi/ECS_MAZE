...
public partial class GameEntity {
    ...
    public Code.Common.EntityLink entityLink { get { return (Code.Common.EntityLink)GetComponent(GameComponentsLookup.EntityLink); } }
    ...
    public GameEntity AddEntityLink(int newValue) {
        ...
        var component = (Code.Common.EntityLink)CreateComponent(index, typeof(Code.Common.EntityLink));
